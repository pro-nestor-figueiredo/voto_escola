"""
Django settings for voto_escola project.
...
SECRET_KEY = 'django-insecure-#zbbwtz37dswf!uj1=sn4uyy%u0=v&_qp+v2vrso)nmh)ggump'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.1.21', 'localhost', '127.0.0.1', 'nestorgf.ddns.net']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'votacao.context_processors.perfil_global',
            ],
        },
    },
]

WSGI_APPLICATION = 'voto_escola.wsgi.application'
